        ...
        <div className="channel-page h-full">
            ...
            <div className="w-[80vw] h-[25vh] bg-[#0f0f0f] flex pl-[5vw] items-center">
                ...
                <div className="w-[70vh] ml-[5vh]">
                    ...
                    <div>more about this channel....<Link href="/user/channel" className='text-gray-500'>more</Link></div>
                    <div className='space-x-5 mt-5'>
                        <Link href="/user/channel/edit" className="p-[1.5vh] bg-[#383838] rounded-full">Customize Channel</Link>
                        <Link href="/user/channel/editVideo h-[2vh]" className="p-[1.5vh] bg-[#383838] rounded-full">Manage Video</Link>
                    </div>
                </div>
            </div>
